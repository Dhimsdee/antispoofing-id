...
def livenessnet(model_Path, le_path, detector_folder, confidence=0.5):
    ...
    time.sleep(2)
    return sequence_count_real, sequence_count_fake
...
if __name__ == '__main__':
    sequence_count_real, sequence_count_fake = livenessnet('LivenessNet.model', 'le.pickle', 'face_detector', confidence=0.5)
